...
var alzRbacRoleDefsJson = [
  loadJsonContent('../../lib/alz/18ac7d82-ea73-5b23-927a-e84f45ab5ccd.alz_role_definition.json')
  loadJsonContent('../../lib/alz/32386256-9e04-5ab9-85ec-57cf057717da.alz_role_definition.json')
  loadJsonContent('../../lib/alz/9f1d994a-8eac-55b9-a174-52a44b281389.alz_role_definition.json')
  loadJsonContent('../../lib/alz/d45d3f5c-c87b-55b5-b672-c04a2f806ca0.alz_role_definition.json')
  loadJsonContent('../../lib/alz/fc69dce5-f499-5e80-904b-d1ef0598afac.alz_role_definition.json')
]
...
var alzPolicyAssignmentsJson = [
  ...
  loadJsonContent('../../lib/alz/Enforce-Sov-L1-Regions.alz_policy_assignment.json')
]
