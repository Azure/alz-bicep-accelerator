...
var alzPolicyAssignmentsJson = [
  ...
  loadJsonContent('../../../lib/alz/platform/connectivity/Enforce-Sov-L2-CMKM.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/platform/connectivity/Enforce-Sov-L2-CMKP.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/platform/connectivity/Enforce-Sov-L2-HTTPS.alz_policy_assignment.json')
  loadJsonContent('../../../lib/alz/platform/connectivity/Enforce-Sov-L2-TLS.alz_policy_assignment.json')
]
