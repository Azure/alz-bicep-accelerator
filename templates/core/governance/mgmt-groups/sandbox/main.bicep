...
metadata description = 'ALZ Bicep Module used to deploy the Sandbox Management Group and associated resources such as policy/policy set definitions, custom RBAC roles, and policy assignments.'
